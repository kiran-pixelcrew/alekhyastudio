export const testimonials = [
  {
    id: "t1",
    quote:
      "Alekhya didn't just photograph my arangetram, she photographed how it felt.",
    name: "Meera Krishnan",
  ...
  },
  {
    id: "t2",
    quote:
      "Our invitation finally felt like us — warm, cultural, and refined. Guests still talk about it.",
    name: "Ananya Reddy",
